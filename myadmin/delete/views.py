...
def railwayMaster(request):
    try:
        station=station_master.objects.values('stnshortcode').distinct()
        datatable=list(models.railwayLocationMaster.objects.values())
...
def add_designation(request):
    try:
        ...
        post=Post_master.objects.filter(delete_flag=True).values('post_code').order_by('post_code').distinct('post_code')
...
#             print(category,paylevel_max,paylevel_min)
